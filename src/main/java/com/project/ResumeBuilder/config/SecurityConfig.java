    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/api/user-profiles/create/{id}").hasAnyAuthority("ROLE_HR", "ROLE_EMPLOYEE")
                        .requestMatchers("/api/candidate-profiles/create/{id}").hasAnyAuthority("ROLE_HR")
                        .requestMatchers("/api/candidate-profiles/upload").permitAll()
